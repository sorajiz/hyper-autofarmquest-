export interface AllQuestsResponse {
	...
	/**
	 * When quest access is suspended until
	 */
	quest_access_suspended_until?: string | null;
}
...
export interface Quest {
	...
	preview: boolean;
	/**
	 * Sealed traffic metadata provided by Discord server
	 */
...
export interface QuestConfig {
	...
	/**
	 * The v2 task configuration for the quest
	 */
...
export interface QuestTaskConfigV2 {
	join_operator: string;
	tasks: Record<string, QuestTaskV2>;
}
